...
<html>
  ...
  <?php
    ...
    echo"<BR><BR>";
  ?>
  <a href="ajoutTrajet.php"><button>Proposer trajet</button></a> <BR><BR>
  <a href="voirmesinscriptiontrajet.php"><button>Voir mes inscriptions Trajets</button></a><BR><BR>
  <a href="voirpropositiontrajet.php"><button>Voir les propositions de Trajets</button></a><BR><BR>
